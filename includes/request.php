...
class Request  extends DatabaseObject {
    ...
    protected static $db_fields = array('request_id', 'user_id', 'office_id','status');
...
// function to check if the request has been previously made

    public static function has_been_made($user_id, $office_id) {
